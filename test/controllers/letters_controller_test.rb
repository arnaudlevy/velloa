...
class LettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post letters_url, params: { letter: { ending_at: @letter.ending_at, starting_at: @letter.starting_at, title: @letter.title } }
    end
  ...
  test "should update letter" do
    patch letter_url(@letter), params: { letter: { ending_at: @letter.ending_at, starting_at: @letter.starting_at, title: @letter.title } }
